        ...
        <el-header class="header">
          <div class="left">
            <div class="operate" ref="operate">
              <el-icon  style="cursor:pointer;font-size:28px;margin-right:10px" v-if="!this.isCollapse"  @click="changeSlidebarState"><Fold /></el-icon>
              <el-icon style="cursor:pointer;font-size:28px;margin-right:10px" v-else @click="changeSlidebarState"><Expand /></el-icon>
              <nav-bar></nav-bar>
            </div>
